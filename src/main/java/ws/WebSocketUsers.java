...
public class WebSocketUsers implements RegistryUsers.ChangeRegistry {
    ...
    public void start(Session session) {
        ...
        try {
            try {
                ...
                String data = om.writeValueAsString(RegistryUsers.listClient());
    ...
    @Override
    public void onPlayerStateChange(RegistryUsers.Client cli) {
        try {
            ObjectMapper om = new ObjectMapper();

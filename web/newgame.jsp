...
<div class="container-fluid">
    ...
    <p class="mb-4">La partie se compose de 4 joueurs max. Et pour jouer avec un ami celui-ci doit être connecté obligatoirement.</p>
    ...
    <div class="card-deck mb-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <select class="selectpicker" id="selectPlayerTeam1" multiple data-max-options="2" data-live-search="true">
                    <option>Test1</option>
                    <option>Test2</option>
                    <option>Test3</option>
                </select>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="selectpicker" id="selectPlayerTeam2" multiple data-max-options="2" data-live-search="true">
                        <option>Test1</option>
                        <option>Test2</option>
                    </select>
                </div>
